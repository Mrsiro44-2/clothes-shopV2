        ...
        <%@include file="../components/header.jsp" %>
            ...
            <div class="page-body">
                <div class="container-xl">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form action="${ctx}/admin/products/${isEdit ? 'edit/'.concat(product.ID) : 'add'}"
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="file" class="form-control" id="mainImgFile" name="mainImgFile"
                                            accept="image/*" />
                                    </div>
                                    <div class="col-md-6 mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" id="description" name="description"
                                        rows="5">${isEdit ? product.description : (not empty param.description ? param.description : '')}</textarea>
                                </div>

                                <div class="row">
                                    <div class="col-md-4 mb-3">
                                        <label class="form-label required">Danh mục</label>
                                        <select name="categoryID" id="categoryID" class="form-select select2-search"
                                            required>
                                            <option value="">-- Chọn danh mục --</option>
                                            <c:set var="cCat"
                                                value="${isEdit ? product.categoryID : (not empty param.categoryID ? param.categoryID : '')}" />
                                            <c:forEach items="${categories}" var="c">
                                                <option value="${c.ID}" data-group-id="${c.sizeGroupID}" ${cCat==c.ID
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <select name="brandID" class="form-select select2-search" required>
                                            ...
                                            <c:set var="cBrand"
                                                value="${isEdit ? product.brandID : (not empty param.brandID ? param.brandID : '')}" />
                                            <c:forEach items="${brands}" var="b">
                                                <option value="${b.ID}" ${cBrand==b.ID ? 'selected' : '' }>${b.name}
                                                </option>
                                            </c:forEach>
                                        </select>
                                    </div>
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <select name="producerID" class="form-select select2-search" required>
                                            ...
                                            <c:set var="cProd"
                                                value="${isEdit ? product.producerID : (not empty param.producerID ? param.producerID : '')}" />
                                            <c:forEach items="${producers}" var="p">
                                                <option value="${p.ID}" ${cProd==p.ID ? 'selected' : '' }>${p.name}
                                                </option>
                                            </c:forEach>
                                        </select>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select name="priority" class="form-select">
                                            <c:set var="cPriority"
                                                value="${isEdit ? product.priority : (not empty param.priority ? param.priority : '1')}" />
                                            <option value="1" ${cPriority==1 ? 'selected' : '' }>Sản phẩm thường (1)
                                            </option>
                                            <option value="2" ${cPriority==2 ? 'selected' : '' }>Sản phẩm Deal (2)
                                            </option>
                                            <option value="3" ${cPriority==3 ? 'selected' : '' }>Sản phẩm Nổi bật (3)
                                            </option>
                                        </select>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select name="status" class="form-select" required>
                                            <c:set var="cStatus"
                                                value="${isEdit ? product.status : (not empty param.status ? param.status : 1)}" />
                    ...
                    <c:if test="${isEdit}">
                        ...
                        <div class="card mt-4">
                            ...
                            <div class="card-body">
                                <form action="${ctx}/admin/product-images/add" method="post"
                                    ...
                                    <c:forEach var="img" items="${images}">
                                        <div class="col-sm-6 col-md-4 col-xl-3">
                                            <div class="card card-sm">
                                                <div class="d-block"><img src="${imgUrl.resolve(img.imgUrl, ctx)}"
                                                ...
                                                <div class="card-body">
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="ms-auto">
                                                            <a href="${ctx}/admin/product-images/delete/${img.ID}?productID=${product.ID}"
                                                                class="text-danger"
                        ...
                        <div class="card mt-4">
                            ...
                            <div class="card-body">
                                <form action="${ctx}/admin/product-variants/add" method="post"
                                    enctype="multipart/form-data" class="mb-4 bg-light p-3 border rounded">
                                    <input type="hidden" name="productID" value="${product.ID}" />
                                        ...
                                        <div class="col-md-3 mb-2">
                                            ...
                                            <select name="sizeOptionID" class="form-select size-select">
                                                <c:forEach var="s" items="${sizes}">
                                                    <option value="${s.ID}" data-group-id="${s.sizeGroupID}">${s.label}
                                                    </option>
                                                </c:forEach>
                                            </select>
                                        </div>
                                    ...
                                    <div class="row mt-2">
                                        ...
                                        <div class="col-md-3 mb-2">
                                            ...
                                            <input type="file" name="variantImgFile" class="form-control"
                                                accept="image/*" />
                                        </div>
                                    </div>
                                    <div class="row mt-2">
                                        <div class="col-md-12 mb-2">
                                            ...
                                            <input type="text" name="variantImgUrl" class="form-control"
                                                placeholder="https://..." />
                                        </div>
                                    </div>
                                    ...
                                    <table class="table table-vcenter card-table">
                                        ...
                                        <tbody>
                                                ...
                                                <tr>
                                                    <td>
                                                        <c:if test="${not empty v.variantImg}">
                                                            <img src="${imgUrl.resolve(v.variantImg, ctx)}" width="40"
                                                                height="40" style="object-fit:cover" class="rounded">
                                                        </c:if>
                                                    </td>
                                                    <td>${v.sku}</td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <c:choose>
                                                            <c:when test="${v.status == 1}"><span
                                                                    class="badge bg-green text-white">Đang bán</span>
                                                            </c:when>
                                                            <c:otherwise><span class="badge bg-red text-white">Đã
                                                                    ẩn</span></c:otherwise>
                                                        </c:choose>
                                                    </td>
                                                    <td>
                                                        <button type="button" class="btn btn-sm btn-primary"
                                                            ...
                                                            onclick="populateEditVariantModal('${v.ID}', '${v.sku}', '${v.barcode}', '${v.colorOptionID}', '${v.sizeOptionID}', '${v.oldPrice}', '${v.newPrice}', '${v.quantity}', '${v.status}', '${v.variantImg}')">Sửa</button>
                                                        <c:choose>
                                                            <c:when test="${v.status == 1}">
                                                                <a href="${ctx}/admin/product-variants/delete/${v.ID}?productID=${product.ID}"
                                                                    class="btn btn-sm btn-danger"
                                                                    onclick="return confirm('Khoá biến thể này?')">Khoá</a>
                                                            </c:when>
                                                            <c:otherwise>
                                                                <a href="${ctx}/admin/product-variants/delete/${v.ID}?productID=${product.ID}"
                                                                    class="btn btn-sm btn-success"
                                                                    onclick="return confirm('Mở khoá biến thể này?')">Mở
                                                                    khoá</a>
                                                                <a href="${ctx}/admin/product-variants/hard-delete/${v.ID}?productID=${product.ID}"
                                                                    class="btn btn-sm btn-danger ms-1"
                                                                    onclick="return confirm('Bạn có chắc chắn muốn xoá biến thể này vĩnh viễn?')">Xoá</a>
                                                            </c:otherwise>
                                                        </c:choose>
                                                    </td>
                                                </tr>
                                            ...
                                            <c:if test="${empty variants}">
                                                <tr>
                                                    <td colspan="8" class="text-center text-muted">Chưa có biến thể nào
                                                    </td>
                                                </tr>
                                            </c:if>
                                        </tbody>
                        ...
                        <!-- Edit Variant Modal -->
                        <div class="modal modal-blur fade" id="editVariantModal" tabindex="-1" role="dialog"
                            aria-hidden="true">
                                ...
                                <form id="editVariantForm" method="post" enctype="multipart/form-data"
                                    ...
                                    <div class="modal-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-3 mb-2">
                                                ...
                                                <select name="sizeOptionID" id="evSize" class="form-select size-select">
                                                    <c:forEach var="s" items="${sizes}">
                                                        <option value="${s.ID}" data-group-id="${s.sizeGroupID}">
                                                            ${s.label}</option>
                                                    </c:forEach>
                                                </select>
                                            </div>
                                            <div class="col-md-3 mb-2">
                                                <label class="form-label">SKU</label>
                                                <input type="text" name="sku" id="evSku" class="form-control"
                                                    required />
                                            </div>
                                            <div class="col-md-3 mb-2">
                                                <label class="form-label">Barcode</label>
                                        ...
                                        <div class="row mt-2">
                                            <div class="col-md-2 mb-2">
                                                <label class="form-label">Giá cũ</label>
                                                <input type="number" name="oldPrice" id="evOldPrice"
                                                    class="form-control" />
                                            </div>
                                            <div class="col-md-2 mb-2">
                                                <label class="form-label">Giá mới</label>
                                                <input type="number" name="newPrice" id="evNewPrice"
                                                    class="form-control" />
                                            </div>
                                            <div class="col-md-2 mb-2">
                                                <label class="form-label">Số lượng</label>
                                                <input type="number" name="quantity" id="evQuantity"
                                                    class="form-control" />
                                            </div>
                                            <div class="col-md-3 mb-2">
                                                <label class="form-label">Trạng thái</label>
                                        ...
                                        <div class="row mt-2">
                                            <div class="col-md-12 mb-2">
                                                <label class="form-label">Hoặc nhập URL ảnh thay thế</label>
                                                <input type="text" name="variantImgUrl" id="evImgUrl"
