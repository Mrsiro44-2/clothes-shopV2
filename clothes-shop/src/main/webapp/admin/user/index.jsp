                                    ...
                                    <tbody>
                                        <c:forEach items="${accounts}" var="acc" varStatus="loop">
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="${ctx}/admin/accounts/edit/${acc.ID}"
                                                        class="btn btn-sm btn-outline-primary me-1">Sửa</a>
                                                    <c:if test="${acc.roleName == 'user'}">
                                                        <a href="${ctx}/admin/accounts/addresses/${acc.ID}"
                                                            class="btn btn-sm btn-outline-info me-1" title="Sổ địa chỉ">
                                                    ...
                                                    <c:if test="${acc.ID != sessionScope.adminAccountId}">
                                                        <a href="${ctx}/admin/accounts/toggle-lock/${acc.ID}"
                                                            class="btn btn-sm ${acc.status == 1 ? 'btn-outline-warning' : 'btn-outline-success'} me-1"
                                        ...
                                        <c:if test="${empty accounts}">
                                            <tr>
                                                <td colspan="9" class="text-center text-muted py-4">Chưa có tài khoản
                                                    nào.</td>
                                            </tr>
                                        </c:if>
                                    </tbody>
