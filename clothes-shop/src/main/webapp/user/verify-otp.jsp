...
<div class="section">
    <div class="container">
        <div class="row" style="margin-bottom: 80px; margin-top: 30px">
            <div class="col-md-6">
                <img src="./user/img/signUp.png" alt="Xác thực OTP" style="width: 100%" />
            </div>
            <div class="col-md-6" style="padding: 100px; margin-top: 70px">
                <h2>Xác thực Email</h2>
                <p>Nhập mã OTP 6 số đã được gửi tới email của bạn. Mã sẽ hết hạn sau 10 phút.</p>
                <form action="${ctx}/verify-otp" method="post">
                    ...
                    <script>
                        document.addEventListener('DOMContentLoaded', function() {
                            ...
                            const form = document.querySelector('form[action="${ctx}/verify-otp"]');
                            if (form) {
                    ...
                    <div>
                        ...
                        <div class="text-left">
                            <p>Không nhận được? <a href="${ctx}/forgot-password" style="color: #db4444;">Thử lại</a></p>
                        </div>
                    </div>
                </form>
            </div>
